...
class OrderDataWidget extends StatefulWidget {
  ...
  @override
  State<OrderDataWidget> createState() => _OrderDataWidgetState();
}

class _OrderDataWidgetState extends State<OrderDataWidget> {
  late OrderDataModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OrderDataModel());
  }
